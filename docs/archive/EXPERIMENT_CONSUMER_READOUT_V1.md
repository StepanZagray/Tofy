...
> **Archived.** Superseded by the Pressure x Grounding V1 screen that was registered to repair the failures found here, and ultimately by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record.
