...
> **Archived.** Never executed — its queue stopped on the parent Pressure x Grounding V1 integrity status and trained zero arms ([`docs/RESULTS_P2.md`](../RESULTS_P2.md), 2026-08-14); superseded by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record.
