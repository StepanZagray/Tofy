...
> **Archived.** Resolved as a negative screen with no cell promoted ([`docs/RESULTS_P2.md`](../RESULTS_P2.md), 2026-08-14) and superseded by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record.
