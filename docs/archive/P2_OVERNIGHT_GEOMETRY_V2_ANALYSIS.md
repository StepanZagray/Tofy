...
> **Archived.** Incomplete experiment with no A/B decision and no promoted arm; superseded by [`P2_GEOMETRY_V2_COMPLETED_PILOT_ANALYSIS.md`](P2_GEOMETRY_V2_COMPLETED_PILOT_ANALYSIS.md) — retained for the experimental record. Launcher scripts referenced below no longer exist.
