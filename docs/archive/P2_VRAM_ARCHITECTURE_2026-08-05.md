...
> **Archived.** Superseded by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2); it measures the v17-era spatial-SIGReg / randomized-depth configuration that no longer exists — retained for the experimental record.
...
This is intentional per `docs/archive/P2_V17.md` / fable5 note 05 (per-cell statistic
...
- `docs/archive/P2_V17.md` — explicitly says re-measure batch at `--outer-steps 8`
