...
> **Archived.** Superseded by the v10-v17 experiment chain and then [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2); its `eval_report_64ep_v3` contract predates the current `p2.eval_report.v18` — retained for the experimental record.
