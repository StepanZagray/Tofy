...
> **Archived.** Pinned to the `p2.eval_report.v10` contract (current is `p2.eval_report.v18`) and superseded by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record.
