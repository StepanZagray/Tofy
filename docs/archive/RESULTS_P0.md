...
> **Archived.** Archived pre-P1 knowledge-transfer / VecLab / Qwen bridge numbers, superseded by [`docs/RESULTS_P1.md`](../RESULTS_P1.md) and the active [`docs/RESULTS_P2.md`](../RESULTS_P2.md) — retained for the experimental record. Launcher scripts referenced below no longer exist.

Archived pre-P1 knowledge-transfer / VecLab / Qwen bridge results. These are
**not** active P1 metrics. Current phase results live in
[`RESULTS_P1.md`](../RESULTS_P1.md).
...
motivate the incompatible clean-slate architecture retained in Git history.
