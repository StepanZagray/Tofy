...
> **Archived.** Superseded by the world-core-v2/v3 campaigns and ultimately [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record. The launcher script referenced below no longer exists.
