...
> **Archived.** The V2/V3 treatments were rejected by the frozen gates ([ADR 0002](../adr/0002-resolved-experiments-and-factual-batches.md)) and the line is superseded by [ADR 0003](../adr/0003-world-core-v5-foundation-v2.md) (world-core-v5 / foundation-v2) — retained for the experimental record. Launcher scripts referenced below no longer exist.
