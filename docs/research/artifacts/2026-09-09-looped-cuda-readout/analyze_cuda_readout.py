...
def common(root, config, *, head, expected_name, audit=False):
    ...
    exact(state['manifest_sha256'], sha, 'external exit manifest')
    ...
    return dict(root=root, manifest=mfest, manifest_sha256=sha, metadata=m, report=r, args=args,
