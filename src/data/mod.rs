...
pub use data::{
    ...
    make_augmented_jepa_batch_from_pairs, make_jepa_batch_from_pairs, make_world_batch_from_slice,
    tokenize_for_inference, tokenize_with_mode, tokenizer_spec, tokenizer_spec_signature,
    AugmentedJepaBatch, CachedPairStream, CachedWorldStream, CurriculumDenoisingConfig, PairStream,
    RawWorldExample, RawWorldStream, TokenizationMode, TokenizerSpec, WorldExample, ACTION_CODE,
    ACTION_DONE, ACTION_FETCH_DOCS, ACTION_TEXT_REPLY, DEFAULT_MIN_TOKENS_PER_LINE,
